...
if (WIN32)
	...
	if (LINK_DYNAMIC_LOOKUP)
		...
		set (C74_SYM_MAX_LINKER_FLAGS "@${C74_MAX_API_DIR}/script/max-linker-flags.txt")
		set (C74_SYM_MSP_LINKER_FLAGS "@${C74_MAX_API_DIR}/script/msp-linker-flags.txt")
		set (C74_SYM_JITTER_LINKER_FLAGS "@${C74_MAX_API_DIR}/script/jitter-linker-flags.txt")

		set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${C74_SYM_MAX_LINKER_FLAGS} ${C74_SYM_MSP_LINKER_FLAGS} ${C74_SYM_JITTER_LINKER_FLAGS}")
		set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${C74_SYM_MAX_LINKER_FLAGS} ${C74_SYM_MSP_LINKER_FLAGS} ${C74_SYM_JITTER_LINKER_FLAGS}")
		set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} ${C74_SYM_MAX_LINKER_FLAGS} ${C74_SYM_MSP_LINKER_FLAGS} ${C74_SYM_JITTER_LINKER_FLAGS}")
	endif ()
endif ()
